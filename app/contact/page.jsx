...
export default function ContactPage() {
    return (
        ...
        //                     <h3 className="text-3xl font-bold mb-8 text-[#f8db98]">Contact Info</h3>
        ...
        //                                     Mantis Dubai, Emirates Financial Towers,<br />
        ...
        //                             </div>
        //                             <div>
        //                                 <h4 className="text-lg font-semibold mb-1">Booking & Info</h4>
        ...
        //                                 <p className="opacity-80 paragraph_three hover:text-[#f8db98] transition-colors">
        //                                     <a href="mailto:info@mantisdubai.com">info@mantisdubai.com</a>
        //                                 </p>
        //                             </div>
        //                         </div>
        //                     </div>
        ...
        //                 {/* Google Map Embed */}
        //                 <div className="w-full h-[300px] rounded-2xl overflow-hidden border border-white/10 shadow-lg bg-gray-900">
        //                     <iframe
        ...
        //                 <p className="opacity-60 mb-8">Fill up the form and our team will get back to you within 24 hours.</p>
        //                 <FormField />
        //             </div>
